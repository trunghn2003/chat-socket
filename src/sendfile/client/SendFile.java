...
public class SendFile extends javax.swing.JFrame {
    ...
    private Socket socket; // Đối tượng Socket để kết nối tới máy chủ.
    private DataInputStream dis; // Đối tượng để đọc dữ liệu từ kết nối socket.
    private DataOutputStream dos; // Đối tượng để ghi dữ liệu ra kết nối socket.
    private String myusername; // Tên của người gửi.
    private String host; // Địa chỉ máy chủ.
    private int port; // Cổng kết nối máy chủ.
    private StringTokenizer st; // Dùng để phân tích thông điệp từ máy chủ.
    private String sendTo; // Tên người nhận.
    private String file; // Đường dẫn đến tệp cần gửi.
    private MainForm main; // Đối tượng MainForm, một lớp khác trong ứng dụng.
                    ...
                    while(!Thread.currentThread().isInterrupted()){
                        ...
                        switch(cmd){
                            case "CMD_RECEIVE_FILE_ERROR":  // Định dạng: CMD_RECEIVE_FILE_ERROR [Message]
                                ...
                                JOptionPane.showMessageDialog(SendFile.this, msg,
                            ...
                            case "CMD_RECEIVE_FILE_ACCEPT":  // Định dạng: CMD_RECEIVE_FILE_ACCEPT [Message]
                                ...
                                new Thread(new SendingFileThread(socket, file, sendTo, 
                                        myusername, SendFile.this)).start();
                                break;
                            ...
                            case "CMD_SENDFILEERROR":
                                ...
                                JOptionPane.showMessageDialog(SendFile.this, 
                                        emsg,"Lỗi", JOptionPane.ERROR_MESSAGE);
                                form.updateAttachment(false);
    ...
    private void initComponents() {
        ...
        btnSendFile.setBackground(new java.awt.Color(153, 255, 255));
